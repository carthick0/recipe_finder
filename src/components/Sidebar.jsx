    ...
    <div className='p-3 md:p-10 border-r min-h-screen w-24 md:w-64 hidden sm:block'>
      <div className='flex flex-col gap-20 sticky top-10 left-0'>
        <div className='w-full'>
          <img src="lll.png" alt="logo" className='hidden md:block' />
          <img src="https://penji.co/wp-content/uploads/2022/08/10.-mr.-d-food-logo.jpg" alt="logo" className='block md:hidden' />
        </div>
